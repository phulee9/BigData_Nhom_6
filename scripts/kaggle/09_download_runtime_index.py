...
LOCAL_RUNTIME_DIR = Path("data/runtime_index/kaggle")
...
FILES_TO_DOWNLOAD = [
    ...
    {
        "object_name": GOLD_KAGGLE_TITLE_INDEX,
        "local_path": LOCAL_RUNTIME_DIR / "title.faiss.index",
    },
    {
        "object_name": GOLD_KAGGLE_SKILLS_INDEX,
        "local_path": LOCAL_RUNTIME_DIR / "skills.faiss.index",
    },
    {
        "object_name": GOLD_KAGGLE_FULL_INDEX,
...
def main() -> None:
    print("Bắt đầu tải runtime index từ MinIO về local")
